...
function App() {
  ...
  return (
    <div style={{ width: "100vw", top: "30%", height: "100%", border: "none", backgroundColor: "black", color: "white", borderRadius: "10px" }} className="flex flex-col justify-center items-center h-screen bg-gradient-to-r from-green-400 to-blue-500">
      ...
      <CSSTransition
        ...
        unmountOnExit
      >
        <div className="modal-wrapper shadow-lg w-[100%] mb-1">
